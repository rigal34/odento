...
class OrderItem
{
   ...
   #[ORM\ManyToOne(targetEntity: Article::class)] // On spécifie explicitement la classe cible
   #[ORM\JoinColumn(nullable: true, onDelete: "SET NULL")] // On définit comment la base de données gère le lien
