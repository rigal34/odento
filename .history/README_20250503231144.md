...
* Revue et approfondissement de concepts Symfony/Twig/HTTP/Git (voir historique de la session pour détails).
* Utilisation des outils de développement navigateur.
* Fonctionnement d'AssetMapper.
