...
## 📂 Structure du projet (Mise à jour avec affichage des commentaires)
...
│   │   └── PostController.php      # MODIFIÉ (gestion soumission et affichage des commentaires)
│   ├── Entity/
│   │   ├── Article.php           # MODIFIÉ (suppression relation vers Comment)
│   │   ├── Comment.php           # MODIFIÉ (relation vers Post au lieu d'Article)
│   │   ├── Post.php              # MODIFIÉ (ajout relation vers Comment, méthodes pour commentaires)
│   │   ├── User.php              # (Relation inverse vers Comment déjà présente)
│   │   # ... (autres entités comme Categorie.php) ...
│   ├── Form/
│   │   ├── CommentFormType.php   # (Créé précédemment pour la soumission)
│   │   └── ContactFormType.php
│   ├── Repository/
│   │   ├── CommentRepository.php # (Créé précédemment)
│   │   # ... (autres repositories) ...
│   └── Security/
│       └── CustomAuthenticator.php # (Modifié précédemment pour redirection post-login)
├── templates/
│   ├── post/
│   │   ├── detail.html.twig      # MODIFIÉ (intégration affichage et formulaire des commentaires)
│   │   └── postindex.html.twig
│   ├── base.html.twig
