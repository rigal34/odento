...
class CheckoutController extends AbstractController
{
  ...
  //MA methode pour la confirmation de commande
    ...
    //J e recupère le  MailService pour envoyer un email de confirmation de commande
    // Cette méthode est appelée lorsque l'utilisateur clique sur "Passer la commande" après avoir rempli le formulaire de checkout
    // Elle crée une nouvelle commande, enregistre les détails du panier et envoie un email de confirmation
    // Elle vide également le panier et les données de checkout de la session
    // Elle redirige l'utilisateur vers la page de remerciement avec l'ID de la commande
