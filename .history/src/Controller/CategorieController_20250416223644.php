...
final class CategorieController extends AbstractController
{
    ...
    public function categorie(EntityManagerInterface $entityManager): Response
    {
        ...
        $categoryElectronique = $entityManager->getRepository(Category::class)->findOneBy(['name' => 'Electronique']);
        return $this->render('home/categorie.html.twig', [
            'voiture' => $categoryVoiture ? $categoryVoiture ->getName() : 'Catégorie par défaut',
            'electronique' => $categoryElectronique ? $categoryElectronique->getDescription() : 'Description par défaut',
