...
class CheckoutController extends AbstractController
{
    ...
    public function thankYouPage(int $orderId): Response // EntityManagerInterface est injecté via le constructeur
    {
        ...
        return $this->render('checkout/thank_you.html.twig', [ // Ou confirmation.html.twig si c'est le nom que tu as gardé
...
} // <<< ACCOLADE FERMANTE de la classe CheckoutController
