...
$session->remove('cart');
$session->remove('checkout_data');
return $this->redirectToRoute('app_checkout_thank_you', ['orderId' => $orderId]);return $this->redirectToRoute('app_checkout_thank_you', ['orderId' => $orderId]);return $this->redirectToRoute('app_checkout_thank_you', ['orderId' => $orderId]);
}
}
