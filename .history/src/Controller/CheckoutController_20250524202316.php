...
public function checkout(Request $request): Response
{
    ...
    if ($form->isSubmitted() 1&& $form->isValid()) {
        // Process the checkout form submission
        // Here you would typically handle payment processing, order creation, etc.
        // For now, we will just redirect to a confirmation page or similar.
