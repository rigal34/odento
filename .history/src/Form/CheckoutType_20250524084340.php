    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('country', CountryType::class, [
                'label' => 'Pays',
                'required' => true,
               'placeholder' => 'Sélectionnez un pays', // Texte pour l'option vide
            // Tu peux définir des pays préférés pour qu'ils apparaissent en haut de la liste
            // 'preferred_choices' => ['FR', 'BE', 'CH'], // Ex: France, Belgique, Suisse
        ])
